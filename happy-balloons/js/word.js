          ...
          // var r = aleft*2;
           ...
           var i2 = setInterval(function() {
             ...
             var r =  "rgba(" + r2 + ", " + r3 + ", " + r4 + ", 1)";
                ...
                pop.play();
                   a.style.backgroundImage = "url(../words/" + q.image+ ")";
...
// };
   ...
   //           var r3 = Math.floor(Math.random()*255);
   //           var r4 = Math.floor(Math.random()*255);
   //          var r5 = Math.floor(Math.random()*4);
           ...
           if (s >= 7) {
            s = 0;
               ...
               more.style.backgroundImage = "url(../images/more"+ s + ".png)";
             
   //               overlay.style.backgroundColor =  "rgba(" + r2 + ", " + r3 + ", " + r4 + ", 0.3"+")";
